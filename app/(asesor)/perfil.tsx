...
/**
 * NOTA: Este archivo es casi idéntico a app/(usuario)/perfil.tsx
 * En un proyecto más grande, esto se podría refactorizar
 * en un componente compartido (ej: src/presentation/components/ProfileScreen).
 * Por ahora, lo duplicamos para mantener la estructura de rutas simple.
 */
...
// Estilos (idénticos al perfil de usuario)
