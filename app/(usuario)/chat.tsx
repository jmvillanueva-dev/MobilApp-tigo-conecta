...
export default function ChatScreen() {
  ...
  const handleSend = async () => {
    ...
    setInputText(""); // Limpiar input inmediatamente para UX
    setSending(true);
    ...
    if (error) {
      ...
      // Opcional: Mostrar alerta o revertir UI
    }
  };
    ...
    <SafeAreaView style={styles.safeArea} edges={["top"]}>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          inverted // Importante: Lista invertida para chat
...
const styles = StyleSheet.create({
  ...
  emptyText: {
    ...
    marginTop: 20,
    transform: [{ scaleY: -1 }],
  }, // Truco para texto en lista invertida
